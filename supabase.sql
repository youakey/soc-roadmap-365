...
--
-- Условие «только если пусто». После первого применения content непуст,
-- и повторный запуск возвращает «no rows» — источник истины дальше база,
-- и файл её не перезаписывает. Чтобы засеять заново, content сначала
-- явно возвращают в '{}'::jsonb — руками и осознанно.
--
